...
public class DBHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("CREATE TABLE IF NOT EXISTS contact"
				+ "(id INTEGER PRIMARY KEY AUTOINCREMENT,contactId INTEGER,sortKey VARCHAR, name VARCHAR, customName VARCHAR,userface_url VARCHAR,sex INTEGER,source INTEGER,lastContactTime VARCHAR,isBlocked boolean,isProvider boolean,lisence VARCHAR,individualResume VARCHAR)");
